...
export default class List extends React.Component<Props, State> {
	...
	componentWillReceiveProps(nextProps: Props) {
		this.setState(() => ({
			...
			oldSelected: nextProps.selected,
	...
	componentDidUpdate(){
		...
		if(this.state.oldSelected !== this.state.selectedItems){
			console.log(this.state.selectedItems);
			this.setState({oldSelected: this.state.selectedItems});
			//this.props.updateChoices(this.state.selectedItems);
		}

...
**lots of work**
divide code into components
update css. this immediately after seperate components
...
DONE:
0.001
input bar for account name
button to accept the input
-on button press add new component
-return all characters associated with account
